...
bias_smoothed_x = get_smoothed_piecewise_bias(number_iterations=ododmetry_translates.shape[1], jumps_number=(2, 8), mult=0.15, smooth_factor=(25, 15), savgol_params=(35, 3))
bias_smoothed_y = get_smoothed_piecewise_bias(number_iterations=ododmetry_translates.shape[1], jumps_number=(2, 8), mult=0.15, smooth_factor=(25, 15), savgol_params=(35, 3))
bias_smoothed_z = get_smoothed_piecewise_bias(number_iterations=ododmetry_translates.shape[1], jumps_number=(2, 8), mult=0.15, smooth_factor=(25, 15), savgol_params=(35, 3))

bias_smoothed = np.vstack((0.4*bias_smoothed_x, 0.4*bias_smoothed_y, 0.4*bias_smoothed_z))

gps_translates = ododmetry_translates + bias_smoothed
